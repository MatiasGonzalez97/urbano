      ...
      <div className="mt-5 flex flex-col gap-5">
        {!isLoading ? (
          <div className="flex flex-col sm:flex-row gap-5">
            <div
              className="card shadow text-white bg-blue-500 flex-1"
            ...
            <div
              className="card shadow text-white bg-indigo-500 flex-1"
              style={{ backgroundColor: '#c1292e' }}
            >
            ...
            <div
              className="card shadow text-white bg-green-500 flex-1"
              style={{ backgroundColor: '#c1292e' }}
            >
              <h1 className="font-semibold sm:text-4xl mb-3 text-center">
